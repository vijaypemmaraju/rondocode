...
import type { Arrangement, JsRegion, NoteSpan, PulseSpan } from '@rondocode/rondo'
...
export interface DocEditor {
  ...
  markPlaying(source: string, notes?: NoteSpan[], jsRegions?: JsRegion[], pulses?: PulseSpan[], arrangement?: Arrangement): void
...
export function createDocEditor(
  ...
  return {
    ...
    markPlaying: (source, notes, jsRegions, pulses, arrangement) => {
      lastGood = source
      playing = true
      if (notes !== undefined) {
