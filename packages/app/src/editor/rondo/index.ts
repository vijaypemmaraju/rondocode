...
export const OPTIONS: RondoOption[] = [
  ...
  c('ddsp', 'function', 'ddsp violin vib:.3 breath:…', 'Trained neural instrument (violin/flute/trumpet/tenorsax). Pitch and velocity wire themselves; breath (dB) shapes timbre, vib adds delayed vibrato.', 'ddsp violin vib:.3'),
