...
export const OPTIONS: RondoOption[] = [
  ...
  c('ddsp', 'function', 'ddsp violin vib:.3 breath:… air:… bright:… scoop:…', 'Trained neural instrument (violin/flute/trumpet/tenorsax). Pitch and velocity wire themselves; breath (dB) shapes timbre, vib adds humanized vibrato, air balances breath noise, bright tilts the spectrum, scoop/fall bend into and out of notes.', 'ddsp violin vib:.3 scoop:1'),
